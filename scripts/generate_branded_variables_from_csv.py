"""
Add branded varaibles to a csv containing CMIP7 DRS variables
"""
...
df["CMIP7_branded_variable_name"] = df.apply(
    lambda row: map_to_cmip_branded_variable(
        row["Physical Parameter"], row["Cell Methods"], row["Dimensions"]
    ),
    axis=1,
)
